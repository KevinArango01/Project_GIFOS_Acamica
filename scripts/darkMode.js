...
let btn_new_gifos_hover = document.getElementsByClassName(
  "btn-new-gifos-hover"
);
...
let small_camara_tape_img = document.getElementsByClassName(
  "small-camara-tape-img"
)[0];
let big_camara_tape_img = document.getElementsByClassName(
  "big-camara-tape-img"
)[0];
...
let twitter_icon_normal = document.getElementsByClassName(
  "twitter-icon-normal"
)[0];
let twitter_icon_hover =
  document.getElementsByClassName("twitter-icon-hover")[0];

night_mode.addEventListener("click", () => {
  page_container[0].classList.toggle("dark-mode");
  night_mode.innerHTML =
    night_mode.innerHTML == "Modo Nocturno" ? "Modo Diurno" : "Modo Nocturno";
